...
//undirected && search
class Comp @Inject()(webJars: WebJarsUtil, lifeCycle: ApplicationLifecycle) extends InhabitationController(webJars, lifeCycle) with DriverDomain with TestDomain with SemanticTypes with RoutingEntries {
